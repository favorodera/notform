...
<template>
  ...
  >
    ...
    />
      ...
      <UContainer
      class="relative py-28 lg:py-36 grid grid-cols-1 justify-items-center text-center"
    >

        <!-- badge -->
        <Motion as="div" :variants="item">
          <UBadge
            variant="subtle"
            color="primary"
        ...
        <!-- title -->
        <Motion as="h1" :variants="item"
            id="landing:hero:title"
            class="
              relative overflow-hidden
              max-w-4xl text-3xl/tight tracking-tight
              text-neutral-800 dark:text-neutral-200
              sm:text-3xl md:text-3xl lg:text-[2.5rem]
            "
          >
        ...
        <!-- description -->
        <Motion as="p" :variants="item"
           class="mt-5 text-base text-muted leading-relaxed max-w-md font-light">
        ...
        <!-- ctas -->
        <Motion as="div" :variants="item"
           class="mt-6 flex flex-wrap items-center justify-center gap-3 sm:mt-8 sm:gap-4 lg:mt-12">
            <UButton
              to="/docs"
              size="lg"
              color="primary"
            ...
            <UButton
              ...
              class="font-mono relative overflow-hidden"
              @click="copy()"
            >
              <span
                class="pointer-events-none absolute inset-0 opacity-[0.07] dark:opacity-[0.13]"
