...
:name-text doesn't impose any styling or UI opinions on your application. Use it with [Nuxt UI](https://ui.nuxt.com), ShadcnVue, Vuetify, Element Plus, PrimeVue, or build your own custom components from scratch.
...
Ready to get started? Head over to the [Installation](/getting-started/installation) guide to add NotForm to your project, or explore the [API Reference](/api/composables/use-not-form) to see everything NotForm can do.
