...
::u-content-list
- [**Schema-Based Validation**]{class="text-primary"}: Use Zod, Yup, or any standard-schema library for powerful, type-safe validation
...
- [**Lightweight**]{class="text-primary"}: Minimal bundle size with zero dependencies beyond your validation library
