...
| --- | --- | --- |
| `name` | `string`{lang="ts-type"} | The path to the array field in the form state. |
| `errors` | `Array<string>`{lang="ts-type"} | Array-level validation errors for the field path. |
