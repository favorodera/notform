...
import type { Component, ComputedRef, MaybeRefOrGetter, Ref, VNodeChild } from 'vue'
 ...
 * @template TSchema The validation schema type derived from ObjectSchema.
 */
export type NotFormContext<TSchema extends ObjectSchema> = {
...
export type NotFormProps<TSchema extends ObjectSchema> = Pick<NotFormContext<TSchema>, 'id'> & {
  ...
  asChild?: boolean
  /** HTML Tag or Vue component `NotForm` should render as - default is `form`. */
  as?: string | Component
}
 ...
 * @template TSchema The validation schema type derived from ObjectSchema.
 */
export type UseNotFormReturn<TSchema extends ObjectSchema> = NotFormContext<TSchema>
